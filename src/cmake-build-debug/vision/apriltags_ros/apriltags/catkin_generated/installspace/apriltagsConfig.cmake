...
if(NOT "include;/usr/local/include/eigen3;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/include/eigen3;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
